...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'SamDu@jiachendu.onmicrosoft.com',
  ...
  protectedRoutes: ['/BACKUP', '/Personal', '/Outlook'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'SamDu@jiachendu.onmicrosoft.com',
